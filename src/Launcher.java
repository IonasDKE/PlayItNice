...
public class Launcher  extends Application {
    ...
    private ComboBox selectPlayerOne;
    private ComboBox selectPlayerTwo;
    private String[] gameSizes = {"2 x 2", "3 x 2" , "4 x 4", "4 x 5", "5 x 6", "8 x 8"};
    private ObservableList<String> typeOfPlayerOne = FXCollections.observableArrayList("Opponent 1", "Human", "MiniMax", "...");
    private ObservableList<String> typeOfPlayerTwo = FXCollections.observableArrayList("Opponent 2", "Human", "MiniMax", "...");
