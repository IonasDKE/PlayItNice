...
public class Launcher  extends Application {
    ...
    private ObservableList<String> typeOfPlayerOne = FXCollections.observableArrayList("Opponent 1", "Human", "Rule Based","Alpha Beta", "Mcts Tree","Mcts Acyclic", "MiniMax", "Rule BasedNoDD");
    private ObservableList<String> typeOfPlayerTwo = FXCollections.observableArrayList("Opponent 2", "Human", "Rule Based","Alpha Beta", "Mcts Tree", "Mcts Acyclic", "MiniMax", "Rule BasedNoDD");
