...
public class Launcher  extends Application {
    ...
    private ObservableList<String> typeOfPlayerOne = FXCollections.observableArrayList("Opponent 1", "Human", "End Square", "...");
    private ObservableList<String> typeOfPlayerTwo = FXCollections.observableArrayList("Opponent 2", "Human", "End Square", "...");
        ...
        startButton.setOnAction((new EventHandler<ActionEvent>() {
            ...
            @Override public void handle(ActionEvent e) {
                ...
                try {
                    ...
                    setOpponents();
                    Scene gamePlay = Board.makeBoard(chosenM,chosenN, players, pOneAI, pTwoAI);
